...
import FancyButton from "./FancyButton"; // Adjust path if FancyButton is elsewhere
    ...
    >
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center justify-center text-center min-h-[70vh] sm:min-h-[80vh] py-16 sm:py-24 md:py-32">
        ...
        <div className="mt-8 sm:mt-10 md:mt-12">
          <FancyButton text="Get In Touch" />
          {/* The onClick for FancyButton is as per your provided FancyButton.js */}
        </div>
